...
game = Game('Fantasia', 'spkerkela', 80, 50, 60)

# Size of the map
MAP_WIDTH = game.screen_width
MAP_HEIGHT = game.screen_height - 7 
...
BAR_WIDTH = 20
PANEL_HEIGHT = 7
PANEL_Y = game.screen_height - PANEL_HEIGHT
MSG_X = BAR_WIDTH + 2
MSG_WIDTH = game.screen_width - BAR_WIDTH - 2
...
def menu(header, options, width):
	...
	header_height = libtcod.console_get_height_rect(con, 0, 0, width, game.screen_width, header)
	if header == '':
		header_height = 0
...
libtcod.console_init_root(game.screen_width,game.screen_height, game.name, False)
#libtcod.console_credits()
con = libtcod.console_new(game.screen_width, game.screen_height)

# Set up GUI panel
panel = libtcod.console_new(game.screen_width, PANEL_HEIGHT)
